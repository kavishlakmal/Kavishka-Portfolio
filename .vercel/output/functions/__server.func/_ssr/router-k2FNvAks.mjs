...
const appCss = "/assets/styles-Bq6RKbey.css";
...
const $$splitComponentImporter = () => import("./index-Cgnv7V43.mjs");
const Route = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Data Science Undergraduate specializing in analytics, business intelligence, predictive modeling, and data-driven solutions."
    }, {
      property: "og:title",
      content: "Kavishka Edirisinghe | Data Science Portfolio"
    }, {
      property: "og:description",
      content: "Data Science Undergraduate specializing in analytics, BI, and predictive modeling."
    }, {
      property: "og:type",
      content: "website"
    }, {
