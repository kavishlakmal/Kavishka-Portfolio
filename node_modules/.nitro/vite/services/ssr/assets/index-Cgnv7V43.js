...
import { Sun, Moon, X, Menu, ArrowRight, Download, Mail, BarChart3, LineChart, Brain, Database, TrendingUp, Code2, Smartphone, MapPin, Briefcase, GraduationCap, BookOpen, Laptop, Award, Filter, PieChart, Layers, Wrench, Calendar, Users, ExternalLink, Check, Copy, Loader2, Send, Phone } from "lucide-react";
      ...
      motion.article,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col flex-1 p-5", children: [
            /* @__PURE__ */ jsx("div", { className: "flex items-start justify-between gap-3", children: /* @__PURE__ */ jsx("h3", { className: "font-display text-base font-semibold leading-tight", children: p.title }) }),
