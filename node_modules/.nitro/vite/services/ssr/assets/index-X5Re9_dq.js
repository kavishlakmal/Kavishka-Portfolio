...
import { Sun, Moon, X, Menu, ArrowRight, Download, Mail, BarChart3, LineChart, Brain, Database, TrendingUp, Code2, Smartphone, MapPin, Briefcase, GraduationCap, BookOpen, Laptop, Award, Filter, PieChart, Layers, Wrench, ArrowUpRight, Calendar, Users, ExternalLink, Check, Copy, Loader2, Send, Phone } from "lucide-react";
import { SiIntellijidea, SiRstudioide, SiPostman, SiGithub, SiDocker, SiMongodb, SiMysql, SiSpringboot, SiExpress, SiNodedotjs, SiReact, SiKotlin, SiPhp, SiCplusplus, SiC, SiJavascript, SiR, SiPython } from "react-icons/si";
  ...
  return /* @__PURE__ */ jsx(
    motion.header,
    {
      ...
      children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-7xl", children: [
        /* @__PURE__ */ jsxs("div", { className: `flex items-center justify-between rounded-2xl px-4 py-3 transition-all ${scrolled ? "glass-strong" : "border border-transparent"}`, children: [
          /* @__PURE__ */ jsxs("button", { onClick: () => go("hero"), className: "group flex items-center gap-2", children: [
            /* @__PURE__ */ jsx("div", { className: "grid size-9 place-items-center rounded-lg border border-primary/40 bg-primary/10 font-display text-sm font-bold text-primary shadow-[0_0_20px_rgba(0,240,255,0.35)] transition-all group-hover:bg-primary/20", children: "KE" }),
            /* @__PURE__ */ jsx("span", { className: "hidden font-display text-sm font-semibold tracking-wide sm:inline", children: "Kavishka Edirisinghe" })
          ] }),
          /* @__PURE__ */ jsx("nav", { className: "hidden items-center gap-1 lg:flex", children: links.map((l) => /* @__PURE__ */ jsxs(
            "button",
            {
              onClick: () => go(l.id),
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1", children: [
            /* @__PURE__ */ jsx(
              "button",
              {
                ...
                children: theme === "dark" ? /* @__PURE__ */ jsx(Sun, { className: "size-5" }) : /* @__PURE__ */ jsx(Moon, { className: "size-5" })
              }
            ),
            /* @__PURE__ */ jsx(
              "button",
...
function Hero() {
  ...
  return /* @__PURE__ */ jsx("section", { id: "hero", className: "relative flex min-h-screen items-center px-4 pt-28 lg:pt-24", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto grid w-full max-w-7xl items-center gap-12 lg:grid-cols-2", children: [
    /* @__PURE__ */ jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "inline-flex items-center gap-2 rounded-full border border-primary/30 bg-primary/10 px-3 py-1 text-xs font-medium text-primary", children: [
            /* @__PURE__ */ jsxs("span", { className: "relative flex size-2", children: [
              /* @__PURE__ */ jsx("span", { className: "absolute inline-flex size-full animate-ping rounded-full bg-primary opacity-75" }),
              /* @__PURE__ */ jsx("span", { className: "relative inline-flex size-2 rounded-full bg-primary" })
            ] }),
            "Available for new opportunities"
          ] }),
          /* @__PURE__ */ jsxs("h1", { className: "mt-6 font-display text-5xl font-bold leading-[1.05] tracking-tight sm:text-6xl lg:text-7xl", children: [
            /* @__PURE__ */ jsx("span", { className: "block text-2xl font-medium text-muted-foreground sm:text-3xl lg:text-4xl", children: "Hi, I'm" }),
            "Kavishka",
            /* @__PURE__ */ jsx("br", {}),
            /* @__PURE__ */ jsx("span", { className: "text-gradient", children: "Edirisinghe" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "mt-4 text-lg font-medium text-primary", children: "Data Science Undergraduate" }),
          /* @__PURE__ */ jsx("p", { className: "mt-3 max-w-xl text-xl text-foreground/90", children: "Transforming Data Into Actionable Insights." }),
          /* @__PURE__ */ jsx("p", { className: "mt-4 max-w-xl text-sm leading-relaxed text-muted-foreground", children: "Motivated Data Science undergraduate with strong foundations in analytics, statistics, business intelligence, and software development. Passionate about turning complex datasets into meaningful solutions." }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "mt-10 flex items-center gap-4", children: [
            /* @__PURE__ */ jsx(
              "a",
              {
                ...
                "aria-label": "GitHub",
                children: /* @__PURE__ */ jsx("svg", { className: "size-5", viewBox: "0 0 24 24", fill: "currentColor", children: /* @__PURE__ */ jsx("path", { d: "M12 0C5.37 0 0 5.37 0 12c0 5.3 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23A11.509 11.509 0 0 1 12 5.803c1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576C20.566 21.797 24 17.3 24 12c0-6.63-5.37-12-12-12z" }) })
              }
            ),
            /* @__PURE__ */ jsx(
              "a",
              {
                ...
                className: "flex size-11 items-center justify-center rounded-full border border-primary/30 bg-primary/10 text-primary transition-all hover:bg-primary/20 hover:shadow-[0_0_20px_rgba(0,240,255,0.4)]",
                "aria-label": "LinkedIn",
                children: /* @__PURE__ */ jsx("svg", { className: "size-5", viewBox: "0 0 24 24", fill: "currentColor", children: /* @__PURE__ */ jsx("path", { d: "M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 0 1-2.063-2.065 2.064 2.064 0 1 1 2.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" }) })
              }
            ),
            /* @__PURE__ */ jsx(
              "a",
...
function About() {
  return /* @__PURE__ */ jsx(Section, { id: "about", eyebrow: "About", title: "Building the future with data", subtitle: "Data-driven thinker. Engineer at heart.", children: /* @__PURE__ */ jsxs("div", { className: "grid items-stretch gap-12 lg:grid-cols-2", children: [
    /* @__PURE__ */ jsx(
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxs("div", { className: "glass-strong rounded-3xl p-7 flex flex-col flex-1", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "mt-4 text-base leading-relaxed text-muted-foreground", children: "From ETL pipelines and warehouse design to full-stack platforms and predictive regression, I love shipping end-to-end solutions that make data useful." }),
          /* @__PURE__ */ jsx("div", { className: "mt-6 flex flex-wrap gap-2", children: skills.map((s) => /* @__PURE__ */ jsxs("div", { className: "inline-flex items-center gap-2 rounded-full border border-primary/25 bg-primary/5 px-3 py-1.5 text-xs", children: [
            /* @__PURE__ */ jsx(s.icon, { className: "size-3.5 text-primary" }),
            s.label
          ] }, s.label)) }),
          /* @__PURE__ */ jsxs("div", { className: "mt-auto pt-8 space-y-3", children: [
            info.map((item, i) => /* @__PURE__ */ jsxs(
              motion.div,
              {
                ...
                children: [
                  /* @__PURE__ */ jsx("div", { className: "flex size-12 shrink-0 items-center justify-center rounded-xl border border-primary/30 bg-primary/10 text-primary", children: /* @__PURE__ */ jsx(item.icon, { className: "size-5" }) }),
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("div", { className: "font-mono text-[10px] uppercase tracking-widest text-muted-foreground", children: item.label }),
                    /* @__PURE__ */ jsx("div", { className: "mt-0.5 text-base font-medium", children: item.value })
                  ] })
                ]
              },
              item.label
            ...
            /* @__PURE__ */ jsxs(
              motion.div,
              {
                ...
                children: [
                  /* @__PURE__ */ jsx("div", { className: "flex size-12 shrink-0 items-center justify-center rounded-xl border border-primary/30 bg-primary/10 text-primary", children: /* @__PURE__ */ jsx(Briefcase, { className: "size-5" }) }),
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("div", { className: "font-mono text-[10px] uppercase tracking-widest text-muted-foreground", children: "Seeking Internship In" }),
                    /* @__PURE__ */ jsx("div", { className: "mt-3 flex flex-wrap gap-2", children: internshipRoles.map((role) => /* @__PURE__ */ jsx("span", { className: "rounded-full border border-primary/30 bg-primary/10 px-2.5 py-0.5 text-xs font-medium text-primary", children: role }, role)) })
                  ] })
                ]
              }
            )
      ...
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "mb-6", children: [
            /* @__PURE__ */ jsx("div", { className: "font-mono text-[11px] uppercase tracking-[0.2em] text-primary", children: "Education" }),
            /* @__PURE__ */ jsx("h3", { className: "mt-1 font-display text-xl font-semibold", children: "Academic Journey" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsx("div", { className: "absolute left-4 top-2 bottom-2 w-px bg-gradient-to-b from-primary/60 via-primary/30 to-transparent sm:left-5" }),
            /* @__PURE__ */ jsx("div", { className: "space-y-6", children: EDUCATION.map((t, i) => /* @__PURE__ */ jsxs(
              motion.div,
              {
                ...
                children: [
                  /* @__PURE__ */ jsx("div", { className: "absolute left-0 top-0 grid size-9 place-items-center rounded-xl border border-primary/40 bg-background text-primary shadow-[0_0_20px_rgba(0,240,255,0.35)] sm:size-10", children: /* @__PURE__ */ jsx(t.icon, { className: "size-4" }) }),
                  /* @__PURE__ */ jsxs("div", { className: "glass rounded-2xl p-4 transition-all hover:border-primary/50 hover:shadow-[0_8px_30px_rgba(0,240,255,0.2)]", children: [
                    /* @__PURE__ */ jsx("div", { className: "font-mono text-[10px] uppercase tracking-[0.2em] text-primary", children: t.period }),
                    /* @__PURE__ */ jsx("h4", { className: "mt-1 font-display text-base font-semibold leading-snug", children: t.title }),
                    t.sub && /* @__PURE__ */ jsx("div", { className: "mt-0.5 text-sm text-foreground/80", children: t.sub }),
                    t.org && /* @__PURE__ */ jsx("div", { className: "mt-0.5 text-xs text-muted-foreground", children: t.org }),
                    /* @__PURE__ */ jsx("div", { className: "mt-3 inline-block rounded-md border border-primary/20 bg-primary/10 px-2.5 py-1 text-xs font-medium text-primary", children: t.detail })
                  ] })
                ]
              },
              i
...
function Skills() {
  ...
  return /* @__PURE__ */ jsxs(Section, { id: "skills", eyebrow: "Skills", title: "A toolkit for modern data work", subtitle: "The stack I use to ship insights and software.", children: [
    /* @__PURE__ */ jsx(
      motion.div,
      {
        initial: { opacity: 0, y: 20 },
        ...
        children: filterButtons.map((btn) => /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsx(btn.icon, { className: "size-3.5" }),
              btn.label,
              activeFilter === btn.id && btn.id !== "all" && /* @__PURE__ */ jsx(
                "button",
                {
                  onClick: (e) => {
                    e.stopPropagation();
    ...
    /* @__PURE__ */ jsx(
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxs("span", { className: "inline-block rounded-full bg-primary/10 px-3 py-1 text-xs text-primary", children: [
          "Showing: ",
    ...
    /* @__PURE__ */ jsx("div", { className: "grid gap-5 sm:grid-cols-2 lg:grid-cols-3", children: getFilteredCategories().map((cat, i) => /* @__PURE__ */ jsxs(
      motion.div,
      {
        initial: { opacity: 0, y: 30 },
        whileInView: { opacity: 1, y: 0 },
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "mb-4 flex items-center gap-3", children: [
            /* @__PURE__ */ jsx("div", { className: "grid size-10 place-items-center rounded-xl border border-primary/30 bg-primary/10 text-primary", children: /* @__PURE__ */ jsx(cat.icon, { className: "size-5" }) }),
            /* @__PURE__ */ jsx("h3", { className: "font-display text-lg font-semibold", children: cat.title })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-1.5", children: cat.items.map((s, j) => /* @__PURE__ */ jsxs(
            motion.span,
            {
              ...
              children: [
                SKILL_ICONS[s] && (() => {
                  ...
                  return /* @__PURE__ */ jsx(Icon, { className: "size-3.5 shrink-0" });
                })(),
                s
              ]
            },
    ...
    getFilteredCategories().length === 0 && /* @__PURE__ */ jsxs(
      motion.div,
      {
        initial: { opacity: 0 },
        animate: { opacity: 1 },
        ...
        children: [
          /* @__PURE__ */ jsx("p", { className: "text-muted-foreground", children: "No skills found in this category." }),
          /* @__PURE__ */ jsx(
            "button",
            {
...
function Projects() {
  ...
  return /* @__PURE__ */ jsxs(Section, { id: "projects", eyebrow: "Projects", title: "Selected work", subtitle: "End-to-end products and experiments across data, web, and mobile.", children: [
    /* @__PURE__ */ jsx(
      motion.div,
      {
        initial: { opacity: 0, y: 20 },
        ...
        transition: { duration: 0.5 },
        className: "mb-10 flex flex-wrap justify-center gap-2",
        children: filterButtons.map((btn) => /* @__PURE__ */ jsx(
          "button",
          {
    ...
    /* @__PURE__ */ jsx("div", { className: "grid gap-5 sm:grid-cols-2 lg:grid-cols-3", children: filteredProjects.map((p, idx) => /* @__PURE__ */ jsxs(
      motion.article,
      {
        initial: { opacity: 0, y: 30 },
        whileInView: { opacity: 1, y: 0 },
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col flex-1 p-5", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-3", children: [
              /* @__PURE__ */ jsx("h3", { className: "font-display text-base font-semibold leading-tight", children: p.title }),
              /* @__PURE__ */ jsx(ArrowUpRight, { className: "size-4 shrink-0 text-muted-foreground transition-all group-hover:-translate-y-0.5 group-hover:translate-x-0.5 group-hover:text-primary" })
            ] }),
            ...
            /* @__PURE__ */ jsx("p", { className: "mt-3 text-sm text-muted-foreground leading-relaxed", children: p.desc }),
            /* @__PURE__ */ jsx("div", { className: "mt-4 flex flex-wrap gap-1.5", children: p.tech.map((t) => /* @__PURE__ */ jsx("span", { className: "rounded-md border border-primary/15 bg-primary/5 px-2 py-0.5 text-[11px] font-medium text-foreground/80", children: t }, t)) }),
            /* @__PURE__ */ jsx("div", { className: "min-h-4 flex-1" }),
            /* @__PURE__ */ jsxs("div", { className: "pt-4 border-t border-border flex items-center gap-2 min-h-[2.25rem]", children: [
              p.liveDemo && /* @__PURE__ */ jsxs(
                "a",
                {
                  href: p.liveDemo,
                  target: "_blank",
              ...
              p.sourceCode && /* @__PURE__ */ jsxs(
                "a",
                {
                  ...
                  className: "inline-flex items-center gap-1.5 rounded-full border border-primary/40 bg-primary/10 px-3 py-1.5 text-xs font-medium text-primary transition-all hover:bg-primary hover:text-primary-foreground hover:border-primary",
                  children: [
                    /* @__PURE__ */ jsx(SiGithub, { className: "size-3" }),
                    "GitHub"
                  ]
                }
              )
...
function Certifications() {
  return /* @__PURE__ */ jsx(Section, { id: "certifications", eyebrow: "Certifications", title: "Continuous learning", subtitle: "Credentials that back the craft.", children: /* @__PURE__ */ jsx("div", { className: "grid gap-4 sm:grid-cols-2 lg:grid-cols-4", children: CERTS.map((c, i) => /* @__PURE__ */ jsxs(
    motion.div,
    {
      initial: { opacity: 0, y: 30 },
      whileInView: { opacity: 1, y: 0 },
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative", children: [
          /* @__PURE__ */ jsx("div", { className: "size-12 overflow-hidden rounded-lg border border-primary/30", children: /* @__PURE__ */ jsx(
            "img",
            {
              src: c.logo,
              alt: c.org,
          ...
          /* @__PURE__ */ jsx("h3", { className: "mt-4 font-display text-sm font-semibold leading-snug", children: c.name }),
          /* @__PURE__ */ jsx("div", { className: "mt-1 text-xs text-muted-foreground", children: c.org }),
          c.issued && /* @__PURE__ */ jsxs("div", { className: "mt-2 inline-block rounded-md border border-primary/20 bg-primary/10 px-2 py-0.5 text-[11px] font-medium text-primary", children: [
            "Issued ",
            c.issued
          ] })
        ] })
...
const INFO = [
  ...
  },
  {
    ...
    icon: () => /* @__PURE__ */ jsx("svg", { className: "size-4", viewBox: "0 0 24 24", fill: "currentColor", children: /* @__PURE__ */ jsx("path", { d: "M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 0 1-2.063-2.065 2.064 2.064 0 1 1 2.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" }) })
  },
  {
    label: "GitHub",
    ...
    icon: () => /* @__PURE__ */ jsx("svg", { className: "size-4", viewBox: "0 0 24 24", fill: "currentColor", children: /* @__PURE__ */ jsx("path", { d: "M12 0C5.37 0 0 5.37 0 12c0 5.3 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23A11.509 11.509 0 0 1 12 5.803c1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576C20.566 21.797 24 17.3 24 12c0-6.63-5.37-12-12-12z" }) })
  }
];
function Contact() {
  ...
  return /* @__PURE__ */ jsx(Section, { id: "contact", eyebrow: "Contact", title: "Let's build something together", subtitle: "Open to internships, collaborations and meaningful conversations.", children: /* @__PURE__ */ jsxs("div", { className: "grid gap-6 lg:grid-cols-5", children: [
    /* @__PURE__ */ jsxs(
      motion.div,
      {
        initial: { opacity: 0, x: -30 },
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsx("h3", { className: "font-display text-xl font-semibold", children: "Connect with Me" }),
            /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-muted-foreground", children: "Reach out via email or social media." }),
            /* @__PURE__ */ jsx("div", { className: "mt-6 space-y-3", children: INFO.map((i) => /* @__PURE__ */ jsxs(
              "a",
              {
                href: i.url,
                ...
                children: [
                  /* @__PURE__ */ jsx("div", { className: "grid size-9 shrink-0 place-items-center rounded-lg border border-primary/30 bg-primary/10 text-primary", children: /* @__PURE__ */ jsx(i.icon, {}) }),
                  /* @__PURE__ */ jsxs("div", { className: "min-w-0 grow", children: [
                    /* @__PURE__ */ jsx("div", { className: "text-[11px] uppercase tracking-wider text-muted-foreground", children: i.label }),
                    /* @__PURE__ */ jsx("div", { className: "truncate text-sm font-medium group-hover:text-primary transition-colors", children: i.value })
                  ] }),
                  /* @__PURE__ */ jsx(
                    "button",
                    {
                      ...
                      children: copied === i.label ? /* @__PURE__ */ jsx(Check, { className: "size-4 text-primary" }) : /* @__PURE__ */ jsx(Copy, { className: "size-4" })
                    }
                  )
                ]
              },
            ...
            /* @__PURE__ */ jsxs("div", { className: "mt-6 border-t border-primary/15 pt-6 space-y-4", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2.5", children: [
                /* @__PURE__ */ jsxs("span", { className: "relative flex size-2.5", children: [
                  /* @__PURE__ */ jsx("span", { className: "absolute inline-flex size-full animate-ping rounded-full bg-green-400 opacity-75" }),
                  /* @__PURE__ */ jsx("span", { className: "relative inline-flex size-2.5 rounded-full bg-green-400" })
                ] }),
                /* @__PURE__ */ jsx("span", { className: "text-sm text-muted-foreground", children: "Available for internships" })
              ] }),
              /* @__PURE__ */ jsxs(
                "a",
                {
    ...
    /* @__PURE__ */ jsxs(
      motion.form,
      {
        ...
        children: [
          /* @__PURE__ */ jsx("h3", { className: "font-display text-xl font-semibold", children: "Send a message" }),
          /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-muted-foreground", children: "I'll get back to you within 24 hours." }),
          /* @__PURE__ */ jsxs("div", { className: "mt-5 grid gap-4 sm:grid-cols-2", children: [
            /* @__PURE__ */ jsx(Field, { label: "Name", name: "name", type: "text", placeholder: "Your name" }),
            /* @__PURE__ */ jsx(Field, { label: "Email", name: "email", type: "email", placeholder: "you@email.com" })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "mt-4", children: /* @__PURE__ */ jsx(Field, { label: "Subject", name: "subject", type: "text", placeholder: "What's this about?" }) }),
          /* @__PURE__ */ jsxs("div", { className: "mt-4", children: [
            /* @__PURE__ */ jsx("label", { className: "text-xs font-medium uppercase tracking-wider text-muted-foreground", children: "Message" }),
            /* @__PURE__ */ jsx(
              "textarea",
              {
                required: true,
          ...
          error && /* @__PURE__ */ jsx("p", { className: "mt-3 text-sm text-destructive", children: "Something went wrong. Please try again." }),
          /* @__PURE__ */ jsx(
            motion.button,
            {
              type: "submit",
...
function Footer() {
  ...
  return /* @__PURE__ */ jsx("footer", { className: "border-t border-primary/15 px-4 py-10", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 text-center sm:flex-row sm:text-left", children: [
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx("div", { className: "font-display text-lg font-semibold", children: "Kavishka Edirisinghe" }),
      /* @__PURE__ */ jsx("div", { className: "text-xs text-muted-foreground", children: "Data Science Undergraduate" })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "font-mono text-xs italic text-muted-foreground", children: '"Transforming Data Into Actionable Insights"' }),
...
function Loader() {
  ...
  return /* @__PURE__ */ jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsx("div", { className: "relative", children: /* @__PURE__ */ jsxs("svg", { width: "400", height: "240", viewBox: "0 0 400 240", className: "overflow-visible", children: [
          /* @__PURE__ */ jsx("defs", { children: /* @__PURE__ */ jsxs("linearGradient", { id: "ke-grad", x1: "0", x2: "1", y1: "0", y2: "1", children: [
            /* @__PURE__ */ jsx("stop", { offset: "0%", stopColor: "#00F0FF" }),
            /* @__PURE__ */ jsx("stop", { offset: "100%", stopColor: "#7DD3FC" })
          ] }) }),
          edges.map(([a, b], i) => /* @__PURE__ */ jsx(
            motion.line,
            {
              x1: nodes[a].x,
              y1: nodes[a].y,
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-4 flex flex-col items-center gap-3", children: [
          /* @__PURE__ */ jsx("div", { className: "h-px w-48 overflow-hidden bg-white/10", children: /* @__PURE__ */ jsx(
            motion.div,
            {
          ...
          /* @__PURE__ */ jsxs("div", { className: "font-mono text-xs tracking-[0.3em] text-muted-foreground", children: [
...
function GridBackground() {
  return /* @__PURE__ */ jsxs("div", { className: "pointer-events-none fixed inset-0 -z-10 overflow-hidden bg-background", children: [
    /* @__PURE__ */ jsx("div", { className: "absolute inset-0 grid-bg radial-fade opacity-60" }),
    /* @__PURE__ */ jsx(
      "div",
      {
